...
<section class="bg-gray-100">
    <div class="mx-auto max-w-[1340px] px-4 py-8 sm:px-6 sm:py-24 lg:me-0 lg:pe-0 lg:ps-8 ">
                                    ...
                                    <div>
                                        <div class="flex">
                                            <div class="flex flex-col items-center justify-center">
                                                <img src="{{ asset('storage/profiles/' . $review->user->filename) }}"
                                                    alt="Image" class="object-cover rounded-full h-12 w-12">
                                            </div>
                                            <div class="flex flex-col items-center justify-center">
